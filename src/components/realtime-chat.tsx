...
export const RealtimeChat = ({
  ...
  return (
    <div className="flex flex-col h-full w-full bg-zinc-900 text-gray-200 antialiased">
      {/* Messages */}
      <div ref={containerRef} className="flex-1 overflow-y-auto p-4 space-y-4">
        {allMessages.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-sm text-gray-400">No messages yet.</p>
            <p className="text-sm bg-gradient-to-r from-[#FF6BBA] to-[#6E86FF] inline-block text-transparent bg-clip-text font-medium">
      ...
      <form onSubmit={handleSendMessage} className="flex w-full gap-2 border-t border-zinc-700 p-4">
        <Input
          className={cn(
