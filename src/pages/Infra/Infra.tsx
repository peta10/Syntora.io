...
// Define feature cards data (Ensure image paths are correct based on previous fix)
const featureCards = [
  {
    id: 1,
    title: "Sales Automation",
    image: "/Infra/image-5.png", // Use root path from public
    description: [
  ...
  },
  {
    ...
    image: "/Infra/image-4.png", // Use root path from public
    description: [
  ...
  },
  {
    ...
    image: "/Infra/image-3.png", // Use root path from public
    description: [
  ...
  },
  {
    ...
    image: "/Infra/image-2.png", // Use root path from public
    description: [
...
export const Infra = (): JSX.Element => {
  ...
  return (
    <div className="w-full bg-black text-white py-16 md:py-24 lg:py-32">
      <div className="w-full max-w-[1200px] mx-auto px-4 flex flex-col gap-16 md:gap-24">
        {/* Top Section: Add relative positioning */}
        <div className="relative flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          {/* Left content section - Ensure z-10 */}
          <div className="relative z-10 flex flex-col w-full lg:w-1/2 gap-8 md:gap-12">
            <div className="flex flex-col gap-5 items-start"> {/* Keep items-start for left align */}
              <Badge
                variant="outline"
              ...
              {/* Apply font styles similar to Bespoke/Process if needed */}
              <div className="space-y-1 font-poppins"> {/* Example: Adding font-poppins */}
                <h2 className="text-[#ffffffde] text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-tight">
                  Automation
                </h2>
                <h2 className="text-[#ffffffde] text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-tight">
                  Infrastructure
              ...
              {/* Use consistent text size/color */}
              <p className="text-[#7b7c8c] text-base md:text-lg leading-relaxed font-inter"> {/* Example: Adding font-inter */}
          ...
          {/* Right content section - Ensure z-10 */}
          <div className="relative z-10 w-full lg:w-1/2 flex items-center justify-center">
            {/* Main circle boundary - Added relative for stacking context */}
            <div className="relative w-[380px] h-[380px] md:w-[420px] md:h-[420px] rounded-full p-1 bg-gradient-to-br from-white/20 via-transparent to-white/20">
              ...
              />
              {/* White inner glow element - Increased opacity and spread */}
              <div 
                className="absolute inset-1 rounded-full shadow-[0_0_5px_3px_rgba(255,255,255,0.9)] pointer-events-none"
              ></div>
              {/* Inner dark circle - Add clip-path */}
              <div 
                className="relative z-10 w-full h-full rounded-full p-2 md:p-4 bg-[radial-gradient(50%_50%_at_50%_50%,rgba(13,13,18,1)_0%,rgba(0,0,0,1)_100%)] flex flex-col items-center justify-center gap-6" 
                     ...
                     >
                       {[...appIconsSecondRow, ...appIconsSecondRow].map((icon, index) => (
                          <div
                              ...
                              className="w-16 h-16 md:w-20 md:h-20 rounded-2xl border border-[#1a1d31]/50 bg-[radial-gradient(50%_50%_at_50%_50%,rgba(26,29,49,0.7)_0%,rgba(0,0,0,0.7)_100%)] flex items-center justify-center flex-shrink-0"
                          >
                              <img
        ...
        {/* Feature Cards Section - Apply motion */}
        <motion.div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center mx-auto"
        ...
        >
          {featureCards.map((card) => (
            <motion.div key={card.id} variants={cardVariants} className="w-full max-w-[320px]">
