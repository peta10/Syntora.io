...
// Updated description text for Features
const descriptionText = "Discover the powerful features Syntora offers to automate your business processes and drive growth.";

// Updated headings for Features
const headings = [
  "Explore Syntora's Powerful", // Updated heading 1
  "Feature Suite", // Updated heading 2
];

// Renamed component to FeaturesHero
export const FeaturesHero = (): JSX.Element => {
  return (
    // Main hero container - Layered background for dot opacity control
    <div
      className="w-full bg-black relative flex items-center justify-center text-center h-[521px] overflow-hidden
